...
static void cookey(const UINT *raw1, UINT *keyout)
{
    UINT *cook;
    const UINT *raw0;
    UINT dough[32];
...
static void deskey(const unsigned char *key, short edf, UINT *keyout)
{
    UINT i, j, l, m, n, kn[32];
...
static void desfunc(UINT *block, const UINT *keys)
{
    UINT work, right, leftt;
    int cur_round;
